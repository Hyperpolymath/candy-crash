...
:experimental:
:url-github: https://github.com/hyperpolymath/candy-crash
:url-gitlab: https://gitlab.com/hyperpolymath/candy-crash
:url-bitbucket: https://bitbucket.org/hyperpolymath/candy-crash
:url-codeberg: https://codeberg.org/hyperpolymath/candy-crash

Gamification library for crash reporting UX
...
candy-crash is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
