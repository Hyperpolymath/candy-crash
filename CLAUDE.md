...
1. **Context**: Always mention if you're working on student features, exam features, or administrative features
2. **Migrations**: Always review generated migrations before running them
3. **Routes**: Check `config/routes.rb` to understand application routing
4. **Models**: Review model relationships and validations in `/app/models`
5. **Controllers**: Keep controller actions RESTful when possible
